...
| 2. The website should allow students to post their activities and ensure that all posts with activities are properly documented. | "lack proper documentation"                                                               |
| 3. The website should allow users to download the portfolio.                                                                     | "The current portfolio does not have the option to download the activities in pdf format" |
...
| 5. The website should allow users to like and comment on other users posts.                                                      | "Does not allow students to collaborate or interact with them"                            |
| 6. The website should have a page with statistics of every student showing the last time that students posted.                   | "they have to open multiple links for each student, which is time-consuming."             |
